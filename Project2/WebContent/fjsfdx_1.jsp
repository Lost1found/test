...
<body style="background-color:#f2e3eb;">
  ...
  <div style="margin:0px auto;
    ...
    <table align='left' cellspacing='0' cellpadding='4' width='1000' border='1' bgcolor='#efefef'>
     <tr>
        <div style="float:left; width:500px; font-size:40px;"><a href="fjsfdx_1.jsp">失卡招领信息</a></div>
        <div style="float:left; width:500px; font-size:40px;"><a href="fjsfdx_2.jsp">寻卡启示信息</a></div>		
     </tr>
     <tr height="40px">
     <td>卡号</td>
     <td>姓名</td>
