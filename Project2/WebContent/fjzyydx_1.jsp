...
<body style="background-color:#f2e3eb;">
  ...
  <%
     ...
     try{
      	...
      	String found="select * from card_founding where ownerSchool='福建中医药大学'";
	...
	margin:0px auto;
	text-align:center;">   
    <img src="images/福建中医药大学.jpg" width='1000' height='282'>  
  </div>
  <div style="margin:0px auto;
    ...
    <table align='left' cellspacing='0' cellpadding='4' width='1000' border='1' bgcolor='#efefef'>
     <tr>
        <div style="float:left; width:500px; font-size:40px;"><a href="fjzyydx_1.jsp">失卡招领信息</a></div>
        <div style="float:left; width:500px; font-size:40px;"><a href="fjzyydx_2.jsp">寻卡启示信息</a></div>		
     </tr>
     <tr height="40px">
     <td>卡号</td>
     <td>姓名</td>
