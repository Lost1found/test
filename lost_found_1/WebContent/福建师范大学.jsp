...
<div style="margin:0px auto;
    ...
    <table align='left' cellspacing='0' cellpadding='4' width='1000' border='1' bgcolor='#efefef'>
     <tr>
     <th bgcolor='#fae6b8'><button type="button" value="失卡招领" name="lost" style="backgroud-color:#efefef">失卡招领</button></th>
     <th bgcolor='#fae6b8'><button type="button" value="寻卡启示" name="find" style="backgroud-color:#efefef">寻卡启事</button></th>
     </tr>
     <tr>
     <td>卡号</td>
     <td>姓名</td>
