...
<%
     ...
     try{
     	...
     	String lost="select * from card_hunting where School='福建闽江学院'";
    ...
    <table align='center' cellspacing='0' cellpadding='4' width='1000' border='1' bgcolor='#efefef'>
     ...
     <%
        for(Picker p:pickers){
        	out.print("卡号："+p.getCard()+"姓名："+p.getOwnerName()+"学校："+p.getOwnerSchool()+"<br>");
            out.print("拾卡人："+p.getPickerName()+"拾卡地点："+p.getPickPlace()+
